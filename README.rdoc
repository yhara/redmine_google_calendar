...
* On the project overview tab I see the iframe code. Could that be removed?
  * Yes, see my Redmine patch #1746 which provides an option to project custom fields to hide them from the project overview especially written for this purpose.
