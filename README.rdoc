...
The currently available, latest stable release of the plugin is version <b>0.1.1</b>.
...
The plugin requires the <tt>tzinfo</tt>-gem (http://tzinfo.rubyforge.org) to be available. If it does not already exist on your server, you can install it using a command like: <tt>$ sudo gem install tzinfo</tt>
...
_URL of the GitHub repository: http://github.com/MischaTheEvil/redmine_google_calendar/tree/master_
